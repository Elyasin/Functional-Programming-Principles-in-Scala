...
abstract class TweetSet {
  ...
  /**
    ...
    * and be implemented in the subclasses?
    */
  def descendingByRetweet = descendingByRetweetAcc(Nil)

  def descendingByRetweetAcc(tweetList: TweetList): TweetList = {
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    ...
    else max(right.mostRetweeted, max(left.mostRetweeted, elem))
  }
...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet =
    TweetReader.allTweets.filter(tweet => google.exists(word => tweet.toString.contains(word)))
  lazy val appleTweets: TweetSet =
    TweetReader.allTweets.filter(tweet => apple.exists(word => tweet.toString.contains(word)))
